...
is_deeply \@results,
  [{you=> 'tie', opponent=> 3, yours=> "rock", theirs=> "rock"},
   {you=> 'tie', opponent=> 4, yours=> "paper", theirs=>"paper"},
   {you=> 'tie', opponent=> 1, yours=> "rock", theirs=> "rock"},
   {you=> 'tie', opponent=> 2, yours=> "paper", theirs=>"paper"},
  ], 'ties';
